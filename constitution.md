...
### أدمن بلص (admin_plus)
```
✅ إدارة المنتجات كاملة (نافذة مبسطة + كاملة)
   - اسم المنتج
   - سعر الجملة
   - سعر القطاعي
   - الكمية
   - متاح / غير متاح
   - عروض للقطاعي (مع تاريخ ومدة)
   - خصومات للجملة (مع تاريخ ومدة)
   - ملاحظات للتاجر (تظهر لعملاء الجملة فقط)
✅ إنشاء فواتير لأي عميل (تاجر أو قطاعي)
✅ الاطلاع على كافة تفاصيل العملاء وإدارتهم إدارة كاملة
✅ إدارة الطلبات كاملة
✅ إدارة المتاجر (جملة + قطاعي)
✅ إدارة المبيعات في الفرعين
✅ إدارة الفروع
✅ إدارة الحسابات والذمم المالية (الصندوق)
✅ إدارة السلايدر
✅ استخدام السايدبار الخاص بالسوبر أدمن
✅ الشريط العلوي وتبويبات الموبايل زي السوبر أدمن

❌ لا يمكنه الوصول لإدارة الصلاحيات
❌ لا يمكنه الوصول للإعدادات الحساسة
❌ لا يمكنه إدارة نسخ احتياطي
❌ لا يمكنه توليد أكواد التجار
❌ لا يمكنه إدارة المستويات والمكافآت
❌ ممنوع تعديل سعر الشراء
❌ ممنوع حذف المستخدمين
```
### 🛡️ الأدمن (admin)
```
